...
class CompraDetalle extends RestController {
	...
	public function index_delete() {
		...
		$respuesta = $this->CompraDetalle_model->delete($id);
		$this->response( $respuesta );
	}
	...
	public function index_post() {
		...
		$result = $this->CompraDetalle_model->set_datos($data);
	...
	public function index_put() {
        $id = $this->uri->segment(2);
		$anterior = $this->CompraDetalle_model->get($id);
		$data = $this->put();
		$data['id'] = $id;
		$this->load->library('form_validation');
		$this->form_validation->set_data($data);
		$obj = $this->CompraDetalle_model->set_datos( $data );
